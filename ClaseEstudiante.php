							...
							<div class="table-responsive">
								<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
									...
									<tbody>
										...
										<?php
										$query = "SELECT * FROM asistenciaestudiante WHERE IdentificacionEstudiante=$Identificacion";
										...
										while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
											<tr>
												...
												<td>
													<a href="AsistenciaEstudiante.php?IdentificacionEstudiante=<?php echo $row['IdentificacionEstudiante'] ?>" class="btn btn-success">
