                                ...
                                <form action="insertamateria.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="CodigoMateria" class="form-control"
                                            placeholder="Digite el codigo de la materia" autofocus required="required"
                                            minlength="3" maxlength="10" title="Ej:SS603">
                                    </div>

                                    <div class="form-group">
                                        <label><b>Nombre de la Materia</b></label>
                                        <input type="text" name="NombreMateria" class="form-control"
                                            placeholder="Digite el Nombre de la Materia" required="" minlength="5"
                                            maxlength="40" title="Ej: Ingeniería de software II">
                                    </div>

                                    <div class="form-group">
                                        <label><b>Creditos</b></label>
                                        <input type="number" name="NumeroCredito" class="form-control"
                                            placeholder="Digite el Número de creditos" minlength="0" maxlength="2"
									...
									<br>
                                    <input type="submit" name="insertamateria" class="btn btn-success btn-block"
                                        value="Registrar">
                                </form>
                            </div>
                        </div>
                                    ...
                                    <div class="table-responsive">
										...
										while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="EditarUsuario.php?CodigoMateria=<?php echo $row['CodigoMateria'] ?>"
                                                            class="btn btn-secondary">
                                                            <i class="fas fa-marker"></i>
                                                        </a>
                                                        <a href="EliminarUsuario.php?CodigoMateria=<?php echo $row['CodigoMateria'] ?>"
