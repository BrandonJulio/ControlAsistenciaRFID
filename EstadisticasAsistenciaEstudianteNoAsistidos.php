...
$sqlcount = "select COUNT(*) as t FROM asistenciaestudiante WHERE Fecha ='".$Fecha."' and Asistio='No asistió'";
...
<html>
<head>
    <title>Inasistencia de estudiants</title>
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="principal.php">Inasistencia de estudiantes por fecha</a>
