                    ...
                    <div class="title">
                            <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" name="FechaExpedicion"
                                                placeholder="*Ingrese Fecha de expedición" required="required">
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="NombrePrograma">
                                            <option value="0">Seleccione un Programa Academico</option>
                                            <?php
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="insertaestudiante" class="btn btn-success"><i
