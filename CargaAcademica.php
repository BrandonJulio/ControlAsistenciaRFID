                            ...
                            <div class="title">
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="Periodo"
                                                            placeholder="Digite el Periodo Academico"
                              ...
                              ?>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="control-label"><b>Primer Dia</b></label>
                                                        <select class="form-control" name="PrimerDia"
                                                            required="required">
                                                            <option>----------</option>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="control-label"><b>Hora Inicio</b></label>
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="control-label"><b>Hora Fin</b></label>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label class="control-label"><b>Segundo Dia</b></label>
                                                        <select class="form-control" name="SegundoDia"
                                                            required="required">
                                                            <option>----------</option>
                                                            <option value="Lunes">Lunes</option>
                                                            <option value="Martes">Martes</option>
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" name="insertacargacademica"
