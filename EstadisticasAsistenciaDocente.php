...
$sql = "select * from asistenciadocente where Fecha='".$Fecha."'"; // Consulta SQL

$sqlcount = "select COUNT(*) as t FROM asistenciadocente WHERE Fecha ='".$Fecha."' and Asistio='Asistió'";
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" href="principal.php">Asistencia de docentes por fecha</a>
