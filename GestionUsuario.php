										...
										while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
											<tr>
												...
												<td>	
													...
													<a href="EliminarUsuario.php?Identificacion=<?php echo $row['Identificacion'] ?>"> <button type="button" class="btn btn-danger " onclick="return ConfirmDelete()">Eliminar</button> 
