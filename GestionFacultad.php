        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Gestión de Facultad</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="principal.php">Menu Principal</a></li>
                        <li class="breadcrumb-item active">Gestión de Facultad</li>
                    </ol>
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="card card-body">
                                <form action="insertafacultad.php" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="NombreFacultad" class="form-control"
                                            placeholder="Digite el nombre de la facultad" autofocus required="required"
                                            minlength="6" maxlength="30" title="Solamente se admiten caracteres">
                                    </div>

                                    <div class="form-group">
                                        <label><b>Cantidad de Programas</b></label>
                                        <input type="number" name="CantidadProgramas" class="form-control"
                                            placeholder="Digite la cantidad de programas" required="" minlength="3"
                                            maxlength="3" pattern="[0-9]{1,10}" title="Solamente se admiten números">

                                    </div>
                                    <div class="form-group">
                                        <label><b>Seleccione sede</b></label><br>
                                        <select name="Sede">
                                            <option value="SedeSabanas">Sede Sabanas</option>
                                            <option value="SedeBellasArtes">Sede Bellas Artes</option>
                                        </select><br>
                                    </div>
									<br>
                                    <input type="submit" name="insertafacultad" class="btn btn-success btn-block"
                                        value="Registrar">
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
										...
										while ($row = mysqli_fetch_assoc($result_tasks)) { ?>
                                        <tr>
                                            <td><?php echo $row['CodigoFacultad']; ?></td>
                                            <td><?php echo $row['NombreFacultad']; ?></td>
                                            <td><?php echo $row['CantidadProgramas']; ?></td>
