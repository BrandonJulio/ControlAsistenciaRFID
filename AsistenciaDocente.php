  ...
  <div class="row">
    ...
    <div class="col-md-4 mx-auto">
      <div class="card card-body">
        <form action="ModficarAsistenciaDocente.php" method="POST">
          <div class="form-group">
            <label>Identificación</label>
            <input name="IdentificacionDocente" type="text" class="form-control" placeholder="Digite Identificacion" autofocus required="">
          </div>
