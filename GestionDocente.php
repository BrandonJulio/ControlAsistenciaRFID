		...
		<div id="layoutSidenav_nav">
			<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
				<div class="sb-sidenav-menu">
					<div class="nav">
						<div class="sb-sidenav-menu-heading">Gestión de Docentes</div>
		...
		<div id="layoutSidenav_content">
			<main>
		     <div class="container-fluid">
				...
				<h1 class="mt-4">Gestión de Docente</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item"><a href="principal.php">Menu Principal</a></li>
						<li class="breadcrumb-item active">Gestión de Docente</li>
					</ol>
                    ...
                    <div class="title">
                            <div class="row">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" name="insertadocente" class="btn btn-success"><i
