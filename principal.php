...
<head>
    ...
    <link href="https://cddn.datatables.net/1.10.20/css/dataTables.bootstrap4.min.css" rel="stylesheet"
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="principal.php">Control de asistencia</a><button
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <div class="row">
                        <img class="background-image" src="imagenes/upc.jpg" width="900" height="700"
